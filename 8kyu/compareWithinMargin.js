...
function close_compare(a, b, margin = 0) {
  ...
  if (margin >= spread) return 0;
  else if (a < b) return -1;
  else if (a > b) return 1;
  else if (spread >= margin) return -1;
  //   else return 1;
}
console.log(close_compare(4, 5));
// console.log(close_compare(5, 5));
// console.log(close_compare(6, 5));
// console.log(close_compare(-6, -5));
// console.log(close_compare(2, 5, 3));
// console.log(close_compare(8.1, 5, 3));
// console.log(close_compare(1.99, 5, 3));
// console.log();
